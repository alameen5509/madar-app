...
export default function HistoryPage() {
  ...
  const fetchEvents = useCallback(async () => {
    ...
    try {
      ...
      if (Array.isArray(data) && data.length > 0) { setEvents(data); setEventsLoading(false); return; }
    } catch {}
    // بيانات مضمّنة تظهر فوراً حتى يتم نشر الباكند
    const fallback = eventCatFilter && eventCatFilter !== "الحرب العالمية الأولى" ? [] : WW1_EVENTS;
    setEvents(fallback);
...
const WW1_EVENTS: HistoricalEvent[] = [
  { id:"e7",orderIndex:7,category:"الحرب العالمية الأولى",title:"معركة فردان (أطول معارك الحرب)",gregorianDate:"21 فبراير - 18 ديسمبر 1916 م",hijriDate:"17 ربيع الآخر - 23 صفر 1335 هـ",location:"مدينة فردان، الجبهة الغربية (شمال شرق فرنسا)",
    description:"شنت القيادة الألمانية هجوماً مدفعياً وبرياً مكثفاً ومستمراً على سلسلة الحصون الفرنسية المحيطة بمدينة فردان، بهدف دفع الجيش الفرنسي إلى نقطة الانهيار عبر \"استنزاف دمائه\". اتسمت المعركة بوحشية غير مسبوقة وتحولت إلى حرب خنادق واستنزاف طاحنة استمرت لما يقارب العشرة أشهر.",
    strategicSignificance:"رغم الخسائر البشرية المرعبة للطرفين، فشلت ألمانيا في تحقيق هدفها باختراق الجبهة أو إسقاط فرنسا. أصبحت فردان رمزاً للصلابة الدفاعية، ولكنها استنزفت الموارد العسكرية الألمانية بشكل خطير، وأضعفت قدرتها المستقبلية على المبادرة بالهجوم."},
  { id:"e8",orderIndex:8,category:"الحرب العالمية الأولى",title:"معركة السوم (ظهور الدبابات الأول)",gregorianDate:"1 يوليو - 18 نوفمبر 1916 م",hijriDate:"1 شعبان - 22 محرم 1335 هـ",location:"حوض نهر السوم، شمال فرنسا",
    description:"نفذت القوات البريطانية والفرنسية هجوماً واسع النطاق ضد الخطوط الألمانية لتخفيف الضغط الخانق عن جبهة فردان. شهد اليوم الأول من المعركة أكبر خسارة في تاريخ الجيش البريطاني، وفي هذه المعركة تم إدخال سلاح \"الدبابة\" لأول مرة في التاريخ العسكري لكسر جمود الخنادق.",
    strategicSignificance:"أثبتت المعركة أن قوات الحلفاء قادرة على تحمل حرب استنزاف طويلة الأمد. ورغم التقدم الجغرافي المحدود، أجبرت هذه المعركة الجيش الألماني لاحقاً على التراجع التكتيكي وإعادة التموضع، وبدأت موازين القوى تميل تدريجياً لصالح الحلفاء بفضل التفوق العددي والصناعي."},
  { id:"e9",orderIndex:9,category:"الحرب العالمية الأولى",title:"انطلاق الثورة العربية الكبرى",gregorianDate:"10 يونيو 1916 م",hijriDate:"9 شعبان 1334 هـ",location:"الحجاز وامتدت إلى بلاد الشام",
    description:"أعلن الشريف حسين بن علي الثورة المسلحة ضد الدولة العثمانية بدعم وتنسيق عسكري ولوجستي من بريطانيا. شملت العمليات العسكرية السيطرة على مكة، وتنفيذ حرب عصابات لتعطيل خط سكة حديد الحجاز، ومهاجمة الحاميات العسكرية العثمانية.",
    strategicSignificance:"نجحت في تشتيت جزء كبير من القوات العثمانية وإلزامها بالبقاء في الحجاز والشام لحماية خطوط الإمداد، مما خفف الضغط عن القوات البريطانية وسهّل تقدمها لاحقاً في فلسطين وسوريا، وشكلت بداية لتغيير الخارطة السياسية للشرق الأوسط."},
  { id:"e10",orderIndex:10,category:"الحرب العالمية الأولى",title:"دخول الولايات المتحدة الأمريكية الحرب",gregorianDate:"6 أبريل 1917 م",hijriDate:"14 جمادى الآخرة 1335 هـ",location:"واشنطن (صنع القرار) والتأثير على الجبهة الغربية والبحرية",
    description:"بعد سلسلة من التوترات، أبرزها استئناف ألمانيا لحرب الغواصات المفتوحة (التي استهدفت السفن التجارية الأمريكية) واعتراض المخابرات البريطانية لـ\"برقية زيمرمان\" (التي حاولت فيها ألمانيا تحريض المكسيك لشن حرب ضد أمريكا)، أعلن الرئيس الأمريكي وودرو ويلسون دخول بلاده الحرب ضد الإمبراطورية الألمانية.",
    strategicSignificance:"يُعد هذا الحدث نقطة التحول الأهم في الحرب؛ إذ وفر التدخل الأمريكي ضخاً هائلاً للقوات البشرية الطازجة، والإمدادات الصناعية، والقدرات المالية للحلفاء في وقت كانوا يعانون فيه من إنهاك شديد، مما رجّح كفة النصر نهائياً وأنهى الآمال الألمانية."},
  { id:"e11",orderIndex:11,category:"الحرب العالمية الأولى",title:"الثورة البلشفية وخروج روسيا من الحرب (معاهدة بريست ليتوفسك)",gregorianDate:"7 نوفمبر 1917 م (الثورة) - 3 مارس 1918 م (توقيع المعاهدة)",hijriDate:"21 محرم 1336 هـ - 19 جمادى الأولى 1336 هـ",location:"روسيا والجبهة الشرقية",
    description:"قاد فلاديمير لينين والبلاشفة ثورة أطاحت بالحكومة الروسية. وبسبب الانهيار الداخلي والرفض الشعبي الواسع للحرب، سارعت الحكومة السوفيتية الجديدة لتوقيع معاهدة سلام منفصلة مع ألمانيا (بريست ليتوفسك)، متنازلة بموجبها عن مساحات شاسعة من الأراضي والموارد.",
    strategicSignificance:"أدى خروج روسيا إلى إغلاق الجبهة الشرقية بالكامل، مما منح ألمانيا فرصة ذهبية لنقل عشرات الفرق العسكرية إلى الجبهة الغربية لشن هجوم حاسم ومحاولة كسب الحرب قبل وصول القوات الأمريكية بأعداد كبيرة."},
  { id:"e12",orderIndex:12,category:"الحرب العالمية الأولى",title:"هجوم الربيع الألماني (هجوم لودندورف)",gregorianDate:"21 مارس - 18 يوليو 1918 م",hijriDate:"8 جمادى الآخرة - 9 شوال 1336 هـ",location:"الجبهة الغربية (فرنسا وبلجيكا)",
    description:"شنت القوات الألمانية سلسلة من الهجمات المكثفة والمباغتة مستخدمة تكتيكات \"قوات الصدمة\" لكسر خطوط الحلفاء وإنهاء الحرب. حقق الهجوم في أسابيعه الأولى تقدماً عميقاً وغير مسبوق منذ عام 1914، وكاد أن يفصل بين القوات البريطانية والفرنسية.",
    strategicSignificance:"رغم النجاح التكتيكي والتقدم الجغرافي، استُنزفت قوات النخبة الألمانية، وتمددت خطوط إمدادها بشكل مفرط أدى لضعفها. شكّل فشل هذا الهجوم في تحقيق نصر استراتيجي قاضٍ نقطة اللاعودة، وبداية النهاية للقدرة الهجومية للإمبراطورية الألمانية."},
  { id:"e13",orderIndex:13,category:"الحرب العالمية الأولى",title:"هجوم المائة يوم (الهجوم المضاد الشامل للحلفاء)",gregorianDate:"8 أغسطس - 11 نوفمبر 1918 م",hijriDate:"30 شوال - 6 صفر 1337 هـ",location:"الجبهة الغربية (بدءاً من معركة أميان)",
    description:"شن الحلفاء (بقيادة بريطانية وفرنسية وبدعم أمريكي كثيف) سلسلة من الهجمات المنسقة. استخدم الحلفاء تكتيكات الأسلحة المشتركة (تنسيق المشاة، الدبابات، الطيران، والمدفعية) لخرق الدفاعات الألمانية الحصينة (مثل خط هيندنبيرغ) وإجبار الجيش الألماني على تراجع مستمر لا توقف فيه.",
    strategicSignificance:"أدى هذا الهجوم الماحق إلى انهيار الروح المعنوية والقدرة العسكرية للجيش الألماني. أدركت القيادة العليا الألمانية حتمية الهزيمة، وتزامن ذلك مع الانهيار الداخلي واستسلام حلفاء ألمانيا (بلغاريا، الدولة العثمانية، ثم النمسا والمجر) واحداً تلو الآخر."},
  { id:"e14",orderIndex:14,category:"الحرب العالمية الأولى",title:"توقيع هدنة كومبيان وانتهاء العمليات العسكرية",gregorianDate:"11 نوفمبر 1918 م (دخلت حيز التنفيذ الساعة 11 صباحاً)",hijriDate:"6 صفر 1337 هـ",location:"غابة كومبيان، فرنسا (داخل عربة قطار)",
    description:"في أعقاب تمرد عسكري داخلي أدى إلى تنازل القيصر الألماني \"فيلهلم الثاني\" عن العرش وإعلان الجمهورية، وقّع الوفد الألماني على اتفاقية هدنة قاسية مع الحلفاء تنص على الوقف الفوري لإطلاق النار، والانسحاب من الأراضي المحتلة، وتسليم العتاد العسكري الثقيل.",
    strategicSignificance:"أنهت هذه الهدنة أربع سنوات من النزاع الدموي المدمّر، ومثّلت السقوط الفعلي للإمبراطوريات العظمى (الألمانية، الروسية، العثمانية، النمساوية المجرية). كما مهدت الطريق لمؤتمر باريس ومعاهدة فرساي (1919) التي أعادت رسم خريطة العالم وأسست لواقع جيوسياسي جديد."},
];
