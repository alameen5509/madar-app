...
public class MadarDbContextFactory : IDesignTimeDbContextFactory<MadarDbContext>
{
    ...
    {
        // Railway PostgreSQL (exposed via TCP proxy)
        var connectionString = Environment.GetEnvironmentVariable("DATABASE_URL")
            ?? "Host=db.yxprisuqztdxevxqgmmc.supabase.co;Port=5432;Database=postgres;Username=postgres;Password=v2CU5NUZHOKlR1BZeyL5V6kzRBnZno9F;SSL Mode=Require;Trust Server Certificate=true";
